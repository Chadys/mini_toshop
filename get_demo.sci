function make_demo(img, file_path)
	...
	imwrite(histo_equalizer(img), file_path+"/08.png")
	imwrite(linear_extension(img), file_path+"/09.png")
	...
	imwrite(brightness(nb_img, 80), file_path+"/16.png")
	imwrite(brightness(nb_img, -80), file_path+"/17.png")
	imwrite(exposure(nb_img, 2), file_path+"/18.png")
	imwrite(exposure(nb_img, 0.5), file_path+"/19.png")
	...
	imwrite(noisify(img,1), file_path+"/29.png")
	imwrite(noisify(nb_img,2,0.02), file_path+"/30.png")
	noise_img = noisify(img, 2, 0.03)
	imwrite(noisify(img,2, 0.3), file_path+"/31.png")
	imwrite(oil_painting(nb_img, [7 7]), file_path+"/32.png")
	...
	imwrite(median(img, [3 3]), file_path+"/54.png")
	imwrite(median(noise_img, [3 3]), file_path+"/55.png")
	imwrite(median(img, [5 5]), file_path+"/56.png")
	...
	imwrite(outlining(img, [3 3]), file_path+"/66.png")
	imwrite(outlining(img, [5 5]), file_path+"/67.png")
